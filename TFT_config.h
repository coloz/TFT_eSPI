...
#elif defined (CONFIG_TFT_SSD1331_DRIVER)
...
#elif defined (CONFIG_TFT_GC9107_DRIVER)
...
#elif defined (CONFIG_TFT_GC9106_DRIVER)
    #define GC9106_DRIVER
#elif defined (CONFIG_TFT_GC9C01_DRIVER)
    #define GC9C01_DRIVER
#elif defined (CONFIG_TFT_HX8347C_DRIVER)
    #define HX8347C_DRIVER
#elif defined (CONFIG_TFT_HX8347D_DRIVER)
    #define HX8347D_DRIVER
#elif defined (CONFIG_TFT_HX8352C_DRIVER)
    #define HX8352C_DRIVER
#elif defined (CONFIG_TFT_HX8357A_DRIVER)
    #define HX8357A_DRIVER
#elif defined (CONFIG_TFT_HX8369A_DRIVER)
    #define HX8369A_DRIVER
#elif defined (CONFIG_TFT_ILI9331_DRIVER)
    #define ILI9331_DRIVER
#elif defined (CONFIG_TFT_ILI9806_DRIVER)
    #define ILI9806_DRIVER
#elif defined (CONFIG_TFT_JBT6K71_DRIVER)
    #define JBT6K71_DRIVER
#elif defined (CONFIG_TFT_JD9613_DRIVER)
    #define JD9613_DRIVER
#elif defined (CONFIG_TFT_NT35310_DRIVER)
    #define NT35310_DRIVER
#elif defined (CONFIG_TFT_NT35510_DRIVER)
    #define NT35510_DRIVER
#elif defined (CONFIG_TFT_NT39125_DRIVER)
    #define NT39125_DRIVER
#elif defined (CONFIG_TFT_NV3001B_DRIVER)
    #define NV3001B_DRIVER
#elif defined (CONFIG_TFT_NV3007_DRIVER)
    #define NV3007_DRIVER
#elif defined (CONFIG_TFT_NV3023_DRIVER)
    #define NV3023_DRIVER
#elif defined (CONFIG_TFT_NV3041A_DRIVER)
    #define NV3041A_DRIVER
#elif defined (CONFIG_TFT_OTM8009A_DRIVER)
    #define OTM8009A_DRIVER
#elif defined (CONFIG_TFT_R61529_DRIVER)
    #define R61529_DRIVER
#elif defined (CONFIG_TFT_RM67162_DRIVER)
    #define RM67162_DRIVER
#elif defined (CONFIG_TFT_RM690B0_DRIVER)
    #define RM690B0_DRIVER
#elif defined (CONFIG_TFT_SEPS525_DRIVER)
    #define SEPS525_DRIVER
#elif defined (CONFIG_TFT_SH1106_DRIVER)
    #define SH1106_DRIVER
#elif defined (CONFIG_TFT_SH8601_DRIVER)
    #define SH8601_DRIVER
#elif defined (CONFIG_TFT_SPD2010_DRIVER)
    #define SPD2010_DRIVER
#elif defined (CONFIG_TFT_SSD1283A_DRIVER)
    #define SSD1283A_DRIVER
#elif defined (CONFIG_TFT_SSD1306_DRIVER)
    #define SSD1306_DRIVER
#elif defined (CONFIG_TFT_SSD1357_DRIVER)
    #define SSD1357_DRIVER
#elif defined (CONFIG_TFT_ST77916_DRIVER)
    #define ST77916_DRIVER
#elif defined (CONFIG_TFT_WEA2012_DRIVER)
...
#if defined (CONFIG_TFT_GC9107_MEMORY_128X128)
    #define GC9107_MEMORY_128X128
#elif defined (CONFIG_TFT_GC9107_MEMORY_128X160)
    #define GC9107_MEMORY_128X160
#endif

#ifdef CONFIG_TFT_GC9107_COL_OFFSET
    #define GC9107_COL_OFFSET CONFIG_TFT_GC9107_COL_OFFSET
#endif

#ifdef CONFIG_TFT_GC9107_ROW_OFFSET
    #define GC9107_ROW_OFFSET CONFIG_TFT_GC9107_ROW_OFFSET
#endif

#if defined (CONFIG_TFT_GC9D01_DUAL_GATE)
    #define GC9D01_DUAL_GATE
#elif defined (CONFIG_TFT_GC9D01_SINGLE_GATE_40X160)
    #define GC9D01_SINGLE_GATE_40X160
#elif defined (CONFIG_TFT_GC9D01_SINGLE_GATE_50X160)
    #define GC9D01_SINGLE_GATE_50X160
#elif defined (CONFIG_TFT_GC9D01_SINGLE_GATE_60X160)
    #define GC9D01_SINGLE_GATE_60X160
#endif

#ifdef CONFIG_TFT_GC9D01_X_OFFSET_LANDSCAPE
    #define GC9D01_X_OFFSET_LANDSCAPE CONFIG_TFT_GC9D01_X_OFFSET_LANDSCAPE
#endif

#ifdef CONFIG_TFT_GC9D01_Y_OFFSET_LANDSCAPE
    #define GC9D01_Y_OFFSET_LANDSCAPE CONFIG_TFT_GC9D01_Y_OFFSET_LANDSCAPE
#endif

#ifdef CONFIG_TFT_GC9D01_X_OFFSET_PORTRAIT
    #define GC9D01_X_OFFSET_PORTRAIT CONFIG_TFT_GC9D01_X_OFFSET_PORTRAIT
#endif

#ifdef CONFIG_TFT_GC9D01_Y_OFFSET_PORTRAIT
    #define GC9D01_Y_OFFSET_PORTRAIT CONFIG_TFT_GC9D01_Y_OFFSET_PORTRAIT
#endif
